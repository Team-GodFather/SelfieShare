...
public class ReceivedFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_received,
				container, false);
		...
		this.listView = (ListView) rootView
				.findViewById(R.id.received_list_view);
	...
	private void loadReceived(final ListView target,
			final ReceivedFragment listActivity) {
		this.queryExecutor
